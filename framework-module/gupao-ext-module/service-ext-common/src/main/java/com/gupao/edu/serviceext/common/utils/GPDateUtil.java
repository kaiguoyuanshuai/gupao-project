 ...
 * 时间：2018/11/7
 */
public class GPDateUtil extends DateUtils {
    ...
    public static boolean validateIsDate(String strTime) {
        ...
        if (date != null) {
            System.out.println("生成的日期:" + GPDateUtil.parseDateToStr(date, GPDateUtil.DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS, "--null--"));
            return true;
        }
        return false;
    }
     ...
     * 判断第一个日期是否比第二个日期晚
     *
     * @param beforeDate 第一个
     * @param afterDate  第二个
     * @return
     */
    public static Boolean after(Date beforeDate, Date afterDate) {
        return beforeDate.getTime() - afterDate.getTime() > 0;
    }
     ...
     * @return
     */
    public static Boolean equalTime(Date beforeDate, Date afterDate) {
        return beforeDate.getTime() - afterDate.getTime() == 0;
    }
